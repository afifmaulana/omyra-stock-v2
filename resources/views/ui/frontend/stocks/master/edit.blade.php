...
@section('content')
    <div class="box-shadow">
        <div class="col-12 shadow-lg">
            ...
            <div class="row justify-content-center">
                <div class="text-header font-size-18 text-active-pink font-weight-500">Form Ubah Stok Master</div>
            </div>
        </div>
    </div>
    <div class="bg-grey pt-23 mt-1" style="max-height: 86vh; overflow: scroll; margin-bottom: 30px">
        <div class="container-omyra" style="margin-bottom: 90px;">
            <form action="{{ route('frontend.master.update', $stock->id) }}" method="POST" enctype="multipart/form-data"
                id="form-tambah">
                @csrf
                @method('put')
                <div class="form-group">
                    ...
                    <input type="text" name="date" id="date"
                        ...
                        placeholder="Masukkan Tanggal Master Datang" autocomplete="off" value="{{ $stock->date }}">
                    @if ($errors->has('date'))
...
@push('scripts')
    ...
    <script>
        ...
        // $(document).on('change', '.brand-master', function() {
