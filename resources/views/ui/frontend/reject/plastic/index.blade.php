...
@section('content')
    ...
    <div class="bg-grey pt-23 mt-1" style="max-height: 86vh; overflow: scroll;">
        ...
        <div class="container-omyra" style="margin-bottom: 90px;">
            <a href="{{ route('frontend.reject.plastic.create') }}" class="float" data-bs-toggle="tooltip"
                    ...
                    @foreach ($rejects as $reject)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="delete-reject" action="{{ route('frontend.reject.plastic.delete', $reject->id) }}"
