...
@section('content')
    <div class="box-shadow">
        <div class="col-12 shadow-lg">
            <div class="py-3">
                <a href="{{ route('frontend.reject.master.index') }}">
                    <img src="{{ asset('images/icon/back.png') }}" width="18" height="18">
                </a>
            </div>
            <div class="row justify-content-center">
                <div class="text-header font-size-18 text-active-pink font-weight-500">Form input master reject</div>
            </div>
        </div>
    </div>
    <div class="bg-grey pt-23 mt-1" style="max-height: 86vh; overflow: scroll; margin-bottom: 30px">
        <div class="container-omyra" style="margin-bottom: 90px;">
            <form action="{{ route('frontend.reject.master.store') }}" method="POST" enctype="multipart/form-data"
                id="form-tambah">
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" name="date" id="date"
                        ...
                        placeholder="Masukkan Tanggal master Reject" autocomplete="off">
                    @if ($errors->has('date'))
                ...
                <div class="form-group">
                    ...
                    <select
                        class="select2 form-control font-size-16 form-omyra product-master {{ $errors->has('material') ? 'is-invalid' : '' }}"
                        id="filter-material" name="material">
                        <option selected disabled>-- Pilih Brand Dulu --</option>
                    </select>
                </div>
                <div class="form-group">
                    <label class="font-weight-500">Jumlah Reject</label>
                ...
                <a class="btn btn-outline-secondary btn-block" href="{{ route('frontend.reject.master.index') }}">Kembali</a>
            </form>
        </div>
    </div>
@endsection
