...
@section('content')
    <div class="box-shadow">
        <div class="col-12 shadow-lg">
            ...
            <div class="row justify-content-center">
                <div class="text-header font-size-18 text-active-pink font-weight-500">Data Inner reject</div>
            </div>
        </div>
    </div>
    <div class="bg-grey pt-23 mt-1" style="max-height: 86vh; overflow: scroll;">
        ...
        <div class="container-omyra" style="margin-bottom: 90px;">
            <a href="{{ route('frontend.reject.inner.create') }}" class="float" data-bs-toggle="tooltip"
                    ...
                    @foreach ($rejects as $reject)
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <form id="delete-reject" action="{{ route('frontend.reject.inner.delete', $reject->id) }}"
