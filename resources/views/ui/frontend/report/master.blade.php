        ...
        <div class="container-omyra" style="margin-bottom: 90px;">
            <form action="#" method="POST" enctype="multipart/form-data" class="myform" id="form-filter">
                ...
                <div class="form-group">
                    ...
                    <select
                        class="select2 form-control font-size-16 form-omyra product-master material-show {{ $errors->has('product') ? 'is-invalid' : '' }}"
            ...
            {{-- <div class="row justify-content-center mb-2">
                <a href="{{ route('frontend.report.record.master') }}" class="btn btn-sm btn-outline-primary">Riwayat <i class="fa fa-eye"></i></a>
            </div> --}}
            ...
            const table = $('#main-table').DataTable({
                ...
                "columns": [
                    ...
                    },
                    {
						title : "Action",
                        data : null,
					    render: (data) => `<a href="{{ route('frontend.report.record.master') }}" class="btn btn-sm btn-outline-warning"><i class="fa fa-history"></i></a>`,
					},
                    // {
                    //     title: "Sisa Stok",
                    //     name: "stock",
