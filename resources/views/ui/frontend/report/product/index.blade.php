    ...
    <div class="box-shadow">
        <div class="col-12 shadow-lg">
            ...
            <div class="row justify-content-center">
                <div class="text-header font-size-18 text-active-pink font-weight-500">Data Ukuran</div>
            </div>
        </div>
    </div>
            ...
            <table id="dataTable" class="table table-striped table-bordered table-responsive" style="width:100%">
                <thead>
                    <tr class="text-center">
                        ...
                        <th>Brand</th>
                        <th>Ukuran</th>
                        <th>Kebutuhan Inner <br> dalam 1 Master</th>
                ...
                <tbody>
                    @foreach ($products as $item)
                        <tr class="text-center">
                            ...
                            <td>{{ $item->size }}</td>
                            <td>{{ $item->need_inner }}</td>
                            <td>{{ $item->stock_semifinish }}</td>
                            <td>{{ $item->stock_finish }}</td>
